...
Der Wochen-Picker für die Planung soll nicht beim nächsten Montag beginnen, sondern beim nächsten Tag. Er soll auch immer das Datum (ohne Jahr, also 30.03) enthalten. Und es sollen die nächsten 10 Tage und nicht nur 7 Tage angezeigt werden. Das erleichtert es, die Planung flexibel zu erstellen.
